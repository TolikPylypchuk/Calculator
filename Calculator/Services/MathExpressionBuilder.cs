...
namespace Calculator.Services
{
    ...
    public sealed class MathExpressionBuilder
    {
        ...
        private readonly StringBuilder builder = new StringBuilder(DefaultExpression);
        private Token lastAddedToken = Token.None;

        private readonly BehaviorSubject<string> expression = new BehaviorSubject<string>(DefaultExpression);
